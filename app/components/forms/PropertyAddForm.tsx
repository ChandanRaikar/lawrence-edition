...
export default function PropertyAddhtmlForm() {
    return (
        <div>
            <form action={addProperty}>
                ...
                <div>
                    <button
                        className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline"
                        type="submit"
                    >
                        Add Property
                    </button>
