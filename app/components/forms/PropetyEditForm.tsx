...
export default function PropertyEditForm({ property }: any) {
    const updatedPropertyById = editProperty.bind(null, property._id)
    return (
        <form action={updatedPropertyById}>
            ...
            <div className="mb-4">
                <button
                    className="mb-4 bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-2 px-4 rounded w-full focus:outline-none focus:shadow-outline"
                    type="submit"
                >
                    Update Property
                </button>
